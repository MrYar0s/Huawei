...
TEST(StackTest, IsEmptyInitially)
{
	...
	ASSERT_EQ(stack::START_SIZE, st_i.max_size());
	ASSERT_EQ(stack::START_SIZE, st_d.max_size());
	ASSERT_EQ(stack::START_SIZE, st_c.max_size());
	ASSERT_EQ(stack::START_SIZE, st_b.max_size());
}
...
TEST(StackTest, PushPopFunc)
{
	stack::Stack<int> ai;
	size_t start = 6745523;
